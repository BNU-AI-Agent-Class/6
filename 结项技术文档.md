...
| 公网 Pages E2E | 3.3.1 普通对话、真实点击紧急按钮、断网双降级与移动视口全部通过 |
| 真机与同伴测试 | 两台手机普通对话通过；3.3.1 真机紧急按钮标红、真人转介、当地紧急服务与 12356 通过 |
| 密钥扫描 | 本地 HEAD、远端 main、Git 历史与前端源码均无真实 key 模式 |

项目已通过 SHIP · S3–S4 上线验收。临时课程 key 风险例外与到期清理要求记录在 `checklists/上线检查清单.md`。
